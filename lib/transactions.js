...
var utils = require(path.join(require.resolve('ripple-lib'), '../ledger/utils'));
var parseTransaction = require(path.join(require.resolve('ripple-lib'), '../ledger/parse/transaction'));
var getTransaction = require(path.join(require.resolve('ripple-lib'), '../ledger/transaction'));
